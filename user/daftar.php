                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="../kategori_d.php">Boot Fashion</a></li>                              
                                </ul>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="full">
                            <form action="" method="POST">
                                <fieldset>
                                    ...
                                    <input type="text" placeholder="Nomor Telepon" name="no_tlpn" required />
                                    <input type="email" placeholder="Email" name="email" required />
                                    <textarea placeholder="Alamat" name="alamat" required></textarea>
                                    <input type="submit" name="submit" value="Submit" />
                                </fieldset>
                                <p class="text-center m-3">Sudah Memiliki Akun? <a href="masuk_user.php">Login Sekarang</a></p>
                                <p class="text-center m-3">Memiliki Akun Admin? <a href="../admin/masuk.php">Masuk Sebagai Pengelola</a></p>
                            </form>                    
                        </div>
                    </div>
                </div>
