...
<html>
   <head>
      ...
      <title>Checkout - FZR Store</title>
      <!-- bootstrap core css -->
   ...
   <body class="sub_page">
      ...
      <!-- Detail Checkout Mulai -->
      <!-- Detail Keranjang Mulai -->
      <div class="card container">
         <div class="container mt-2">
            <h5 class="card-header text-center bg-primary">Formulir Checkout</h5>
         </div>

         <div class="container mt-2">
         <div class="row row-product">
               <div class="col">
                  <h5 class="card-header text-center bg-warning">Ringkasan Belanja</h5>
         ...
         <?php
         $pelanggan = $koneksi->query('SELECT * FROM user');
         $pelanggan = $pelanggan->fetch_assoc();
         ?>

                  <div class="card container mt-3">
                     <div class="container mt-3 mb-3">
                        <h5 class="card-header text-center bg-primary"><i class='bx bxs-user'></i>Informasi Pribadi</h5>
                        <input type="text" class="form-control mb-1" value="<?php echo $pelanggan['nama']; ?>" readonly>
                        <input type="text" class="form-control mb-1" value="<?php echo $pelanggan['username']; ?>" readonly>
                        <input type="text" class="form-control mb-1" value="<?php echo $pelanggan['email']; ?>" readonly>
                        <input type="text" class="form-control mb-1" value="<?php echo $pelanggan['no_tlpn']; ?>" readonly>
                     </div>
                  </div>

                  <div class="card container mt-3 item-center">
                     <div class="container mt-3">
                        <h5 class="card-header text-center bg-primary"><i class='bx bxs-user'></i>Formulir Alamat</h5>
                        <form action="" method="post" class="mb-4">
                           ...
                           <label class="col-sm-3 col-form-label">Pilih Jasa Ekspedisi: </label>
                           <div class="col-sm-10">
                           ...
                           <label class="col-sm-3 col-form-label">Pilih Pengiriman: </label>
                           <div class="col-sm-10">
                              <select name="pengiriman" class="form-control">
                                 <option value="">Jenis Pengiriman</option>
                              </select>
                           </div>
                           <input type="text" name="total_berat" id="" value="1000" hidden>
                        
                           <label class="col-sm-3 col-form-label">Alamat Lengkap:</label>
                           <div class="col-sm-10 mb-2">
                              <textarea name="alamat" cols="30" rows="10" placeholder="Jl. Sarimakmur Raya Nomor 28. Rt. 002 RW. 002"></textarea>
                           </div>

                        <div class="col-form-label" hidden>
                           <input type="text" name="nama_provinsi" class="form-control">
                           <input type="text" name="nama_distrik" class="form-control">
                           <input type="text" name="tipe_distrik" class="form-control">
                  ...
                  <div class="row row-product mt-3">
                     <div class="col">
                        <div class="table">
                           <tr>                     
                              <td class="text-left"><a href="detail_keranjang.php" class="btn btn-sm btn-danger">Batal</a></td>
                              <td class="text-right"><a href="../midtrans/examples/snap/checkout-process.php" class="btn btn-sm btn-success">Pesan</a></td>                    
                           </tr>
                        </div>
                      </div>
                  </div>
